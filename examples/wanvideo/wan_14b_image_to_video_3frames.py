...
base_mid_frame_dir = "/public/home/lingwang/lmj/kevin/DiffSynth-Studio/data/examples/selected_dataset/middle_frame_wan"
base_save_dir = "/public/home/lingwang/lmj/kevin/DiffSynth-Studio/results/examples/wan/mid_auto_generated_avg"
    ...
    for i in indices:
        ...
        images.append(
            [
                ...
                Image.open(os.path.join(dataset_mid_frame_dir, f"{i}.png")).convert("RGB"),
...
for name, imgs, prompt, dir in zip(names, images, prompts, save_dirs):
    ...
    # np.save(os.path.join(base_save_dir, f"{dataset_name}_attn_map.npy"), cache["scaled_dot_product_attention"], allow_pickle=True)
    # get_local.clear()
